...
class CorporatePersonnel(models.Model):
    ...
    personnal_employment_status = models.CharField(max_length=20, choices=EMPLOYMENT_STATUS_CHOICES, default='active', verbose_name="وضعیت استخدام")
    personnal_salary = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, verbose_name="حقوق")
    personnal_profile_picture = models.ImageField(upload_to='personnel_pics/', blank=True, null=True, verbose_name="عکس پروفایل")
